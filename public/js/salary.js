    ...
    rewards.forEach((reward) => {
        ...
        html += `
            <div style="display: flex; justify-content: space-between; align-items: center; padding: 3px 0; border-bottom: 1px solid #e0e0e0;">
                ...
                ${reward.autoGenerated ? '' : `<button onclick="removeRewardPunishment('${teacherName}', ${reward.id})" style="padding: 3px 6px; font-size: 12px; background: #dc3545; color: white; border: none; border-radius: 3px; cursor: pointer;">Remove</button>`}
            </div>
        `;
    });
